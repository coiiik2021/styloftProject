                ...
                <div class="card bg-glass">
                    <div class="card-body px-4 py-5 px-md-5">
                        <form action="/login" method="POST">
                            ...
                            <h2 class="display-7 fw-bold" style="color: #740c0c;">ĐĂNG NHẬP</h2>
                            ...
                            <div class="mb-3">
                                ...
                                <input placeholder="Nhập email"
                                       type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="username" required>
                                <div id="emailHelp" class="form-text">Chúng tôi sẽ không chia sẽ thông tin với bất kỳ bên </div>
                            </div>
