          ...
          <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
            ...
            <div class="card bg-glass">
              <div class="card-body px-4 py-5 px-md-5">
                ...
                <a href="https://www.facebook.com/v19.0/dialog/oauth?fields=id,name,email,picture&client_id=1059853482122901&redirect_uri=http://localhost:8080/facebook" class="btn btn-google">
